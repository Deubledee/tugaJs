...
import { _getCategories, _getPages } from '../../../lib/app_defalut_http-requests';
export function getContent(data) {
    let queries = `getPages(projectId: "tugajs", removed: false, Published: "NP", lang: "${data}") {
                    ... on Categories {
...
export function getCategory(view) {
    let queries = `getPageCategory(projectId: "tugajs", removed: false, category: "${view}", Published: "NP"){
                   ...on Categories {
